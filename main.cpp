...
static uint32_t ghost_dot[14][14] = {};
void ghost();
...
int main() {
  ...
  while (1) {
    ...
    move_left(&pacman_point);
    move_left(&ghost_point);

    for (int i = 0; i < 14; i++) {
      for (int j = 0; j < 14; j++) {
        lcd.DrawPixel(pacman_point.X + j, pacman_point.Y + i, pacman_dot[i][j]);
      }
    }
    for (int i = 0; i < 14; i++) {
      for (int j = 0; j < 14; j++) {
        lcd.DrawPixel(ghost_point.X + j, ghost_point.Y + i, ghost_dot[i][j]);
      }
    }
...
{
  using lcd_color::kBLACK;
  using lcd_color::kRED;
  using lcd_color::kWHITE;
  using lcd_color::kBLUE;

  ghost_dot[0x0][0x0] = kBLACK;
  ghost_dot[0x0][0x1] = kBLACK;
  ghost_dot[0x0][0x2] = kBLACK;
  ghost_dot[0x0][0x3] = kBLACK;
  ghost_dot[0x0][0x4] = kBLACK;
  ghost_dot[0x0][0x5] = kRED;
  ghost_dot[0x0][0x6] = kRED;
  ghost_dot[0x0][0x7] = kRED;
  ghost_dot[0x0][0x8] = kRED;
  ghost_dot[0x0][0x9] = kBLACK;
  ghost_dot[0x0][0xA] = kBLACK;
  ghost_dot[0x0][0xB] = kBLACK;
  ghost_dot[0x0][0xC] = kBLACK;
  ghost_dot[0x0][0xD] = kBLACK;

  ghost_dot[0x1][0x0] = kBLACK;
  ghost_dot[0x1][0x1] = kBLACK;
  ghost_dot[0x1][0x2] = kBLACK;
  ghost_dot[0x1][0x3] = kRED;
  ghost_dot[0x1][0x4] = kRED;
  ghost_dot[0x1][0x5] = kRED;
  ghost_dot[0x1][0x6] = kRED;
  ghost_dot[0x1][0x7] = kRED;
  ghost_dot[0x1][0x8] = kRED;
  ghost_dot[0x1][0x9] = kRED;
  ghost_dot[0x1][0xA] = kRED;
  ghost_dot[0x1][0xB] = kBLACK;
  ghost_dot[0x1][0xC] = kBLACK;
  ghost_dot[0x1][0xD] = kBLACK;

  ghost_dot[0x2][0x0] = kBLACK;
  ghost_dot[0x2][0x1] = kBLACK;
  ghost_dot[0x2][0x2] = kRED;
  ghost_dot[0x2][0x3] = kRED;
  ghost_dot[0x2][0x4] = kRED;
  ghost_dot[0x2][0x5] = kRED;
  ghost_dot[0x2][0x6] = kRED;
  ghost_dot[0x2][0x7] = kRED;
  ghost_dot[0x2][0x8] = kRED;
  ghost_dot[0x2][0x9] = kRED;
  ghost_dot[0x2][0xA] = kRED;
  ghost_dot[0x2][0xB] = kRED;
  ghost_dot[0x2][0xC] = kBLACK;
  ghost_dot[0x2][0xD] = kBLACK;

  ghost_dot[0x3][0x0] = kBLACK;
  ghost_dot[0x3][0x1] = kRED;
  ghost_dot[0x3][0x2] = kWHITE;
  ghost_dot[0x3][0x3] = kWHITE;
  ghost_dot[0x3][0x4] = kRED;
  ghost_dot[0x3][0x5] = kRED;
  ghost_dot[0x3][0x6] = kRED;
  ghost_dot[0x3][0x7] = kRED;
  ghost_dot[0x3][0x8] = kWHITE;
  ghost_dot[0x3][0x9] = kWHITE;
  ghost_dot[0x3][0xA] = kRED;
  ghost_dot[0x3][0xB] = kRED;
  ghost_dot[0x3][0xC] = kRED;
  ghost_dot[0x3][0xD] = kBLACK;

  // TODO white and blue
  ghost_dot[0x4][0x0] = kBLACK;
  ghost_dot[0x4][0x1] = kRED;
  ghost_dot[0x4][0x2] = kRED;
  ghost_dot[0x4][0x3] = kRED;
  ghost_dot[0x4][0x4] = kRED;
  ghost_dot[0x4][0x5] = kRED;
  ghost_dot[0x4][0x6] = kRED;
  ghost_dot[0x4][0x7] = kRED;
  ghost_dot[0x4][0x8] = kRED;
  ghost_dot[0x4][0x9] = kRED;
  ghost_dot[0x4][0xA] = kRED;
  ghost_dot[0x4][0xB] = kRED;
  ghost_dot[0x4][0xC] = kRED;
  ghost_dot[0x4][0xD] = kBLACK;

  ghost_dot[0x5][0x0] = kBLACK;
  ghost_dot[0x5][0x1] = kRED;
  ghost_dot[0x5][0x2] = kRED;
  ghost_dot[0x5][0x3] = kRED;
  ghost_dot[0x5][0x4] = kRED;
  ghost_dot[0x5][0x5] = kRED;
  ghost_dot[0x5][0x6] = kRED;
  ghost_dot[0x5][0x7] = kRED;
  ghost_dot[0x5][0x8] = kRED;
  ghost_dot[0x5][0x9] = kRED;
  ghost_dot[0x5][0xA] = kRED;
  ghost_dot[0x5][0xB] = kRED;
  ghost_dot[0x5][0xC] = kRED;
  ghost_dot[0x5][0xD] = kBLACK;

  ghost_dot[0x6][0x0] = kRED;
  ghost_dot[0x6][0x1] = kRED;
  ghost_dot[0x6][0x2] = kRED;
  ghost_dot[0x6][0x3] = kRED;
  ghost_dot[0x6][0x4] = kRED;
  ghost_dot[0x6][0x5] = kRED;
  ghost_dot[0x6][0x6] = kRED;
  ghost_dot[0x6][0x7] = kRED;
  ghost_dot[0x6][0x8] = kRED;
  ghost_dot[0x6][0x9] = kRED;
  ghost_dot[0x6][0xA] = kRED;
  ghost_dot[0x6][0xB] = kRED;
  ghost_dot[0x6][0xC] = kRED;
  ghost_dot[0x6][0xD] = kRED;

  ghost_dot[0x7][0x0] = kRED;
  ghost_dot[0x7][0x1] = kRED;
  ghost_dot[0x7][0x2] = kRED;
  ghost_dot[0x7][0x3] = kRED;
  ghost_dot[0x7][0x4] = kRED;
  ghost_dot[0x7][0x5] = kRED;
  ghost_dot[0x7][0x6] = kRED;
  ghost_dot[0x7][0x7] = kRED;
  ghost_dot[0x7][0x8] = kRED;
  ghost_dot[0x7][0x9] = kRED;
  ghost_dot[0x7][0xA] = kRED;
  ghost_dot[0x7][0xB] = kRED;
  ghost_dot[0x7][0xC] = kRED;
  ghost_dot[0x7][0xD] = kRED;

  ghost_dot[0x8][0x0] = kRED;
  ghost_dot[0x8][0x1] = kRED;
  ghost_dot[0x8][0x2] = kRED;
  ghost_dot[0x8][0x3] = kRED;
  ghost_dot[0x8][0x4] = kRED;
  ghost_dot[0x8][0x5] = kRED;
  ghost_dot[0x8][0x6] = kRED;
  ghost_dot[0x8][0x7] = kRED;
  ghost_dot[0x8][0x8] = kRED;
  ghost_dot[0x8][0x9] = kRED;
  ghost_dot[0x8][0xA] = kRED;
  ghost_dot[0x8][0xB] = kRED;
  ghost_dot[0x8][0xC] = kRED;
  ghost_dot[0x8][0xD] = kRED;

  ghost_dot[0x9][0x0] = kRED;
  ghost_dot[0x9][0x1] = kRED;
  ghost_dot[0x9][0x2] = kRED;
  ghost_dot[0x9][0x3] = kRED;
  ghost_dot[0x9][0x4] = kRED;
  ghost_dot[0x9][0x5] = kRED;
  ghost_dot[0x9][0x6] = kRED;
  ghost_dot[0x9][0x7] = kRED;
  ghost_dot[0x9][0x8] = kRED;
  ghost_dot[0x9][0x9] = kRED;
  ghost_dot[0x9][0xA] = kRED;
  ghost_dot[0x9][0xB] = kRED;
  ghost_dot[0x9][0xC] = kRED;
  ghost_dot[0x9][0xD] = kRED;

  ghost_dot[0xA][0x0] = kRED;
  ghost_dot[0xA][0x1] = kRED;
  ghost_dot[0xA][0x2] = kRED;
  ghost_dot[0xA][0x3] = kRED;
  ghost_dot[0xA][0x4] = kRED;
  ghost_dot[0xA][0x5] = kRED;
  ghost_dot[0xA][0x6] = kRED;
  ghost_dot[0xA][0x7] = kRED;
  ghost_dot[0xA][0x8] = kRED;
  ghost_dot[0xA][0x9] = kRED;
  ghost_dot[0xA][0xA] = kRED;
  ghost_dot[0xA][0xB] = kRED;
  ghost_dot[0xA][0xC] = kRED;
  ghost_dot[0xA][0xD] = kRED;

  ghost_dot[0xB][0x0] = kRED;
  ghost_dot[0xB][0x1] = kRED;
  ghost_dot[0xB][0x2] = kRED;
  ghost_dot[0xB][0x3] = kRED;
  ghost_dot[0xB][0x4] = kRED;
  ghost_dot[0xB][0x5] = kRED;
  ghost_dot[0xB][0x6] = kRED;
  ghost_dot[0xB][0x7] = kRED;
  ghost_dot[0xB][0x8] = kRED;
  ghost_dot[0xB][0x9] = kRED;
  ghost_dot[0xB][0xA] = kRED;
  ghost_dot[0xB][0xB] = kRED;
  ghost_dot[0xB][0xC] = kRED;
  ghost_dot[0xB][0xD] = kRED;

  ghost_dot[0xC][0x0] = kRED;
  ghost_dot[0xC][0x1] = kRED;
  ghost_dot[0xC][0x2] = kRED;
  ghost_dot[0xC][0x3] = kRED;
  ghost_dot[0xC][0x4] = kBLACK;
  ghost_dot[0xC][0x5] = kRED;
  ghost_dot[0xC][0x6] = kRED;
  ghost_dot[0xC][0x7] = kRED;
  ghost_dot[0xC][0x8] = kRED;
  ghost_dot[0xC][0x9] = kBLACK;
  ghost_dot[0xC][0xA] = kRED;
  ghost_dot[0xC][0xB] = kRED;
  ghost_dot[0xC][0xC] = kRED;
  ghost_dot[0xC][0xD] = kRED;

  ghost_dot[0xD][0x0] = kBLACK;
  ghost_dot[0xD][0x1] = kRED;
  ghost_dot[0xD][0x2] = kRED;
  ghost_dot[0xD][0x3] = kBLACK;
  ghost_dot[0xD][0x4] = kBLACK;
  ghost_dot[0xD][0x5] = kBLACK;
  ghost_dot[0xD][0x6] = kRED;
  ghost_dot[0xD][0x7] = kRED;
  ghost_dot[0xD][0x8] = kBLACK;
  ghost_dot[0xD][0x9] = kBLACK;
  ghost_dot[0xD][0xA] = kBLACK;
  ghost_dot[0xD][0xB] = kRED;
  ghost_dot[0xD][0xC] = kRED;
  ghost_dot[0xD][0xD] = kBLACK;
}
